...
Config::Config(const Config& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.follow_height_m_){}
    , decltype(_impl_.follow_distance_m_){}
    , decltype(_impl_.responsiveness_){}
    , decltype(_impl_.altitude_mode_){}
    , decltype(_impl_.max_tangential_vel_m_s_){}
    , decltype(_impl_.follow_angle_deg_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.follow_height_m_, &from._impl_.follow_height_m_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.follow_angle_deg_) -
...
TargetLocation::TargetLocation(const TargetLocation& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  TargetLocation* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.latitude_deg_){}
    , decltype(_impl_.longitude_deg_){}
    , decltype(_impl_.absolute_altitude_m_){}
    , decltype(_impl_.velocity_x_m_s_){}
    , decltype(_impl_.velocity_y_m_s_){}
    , decltype(_impl_.velocity_z_m_s_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.latitude_deg_, &from._impl_.latitude_deg_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.velocity_z_m_s_) -
...
// @@protoc_insertion_point(message_clear_start:mavsdk.rpc.follow_me.SetConfigResponse)
  ...
  if (GetArenaForAllocation() == nullptr && _impl_.follow_me_result_ != nullptr) {
