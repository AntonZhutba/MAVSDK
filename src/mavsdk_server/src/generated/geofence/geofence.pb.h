...
inline bool UploadGeofenceRequest::_internal_has_geofence_data() const {
  return this != internal_default_instance() && _impl_.geofence_data_ != nullptr;
}
...
inline void UploadGeofenceRequest::clear_geofence_data() {
  if (GetArenaForAllocation() == nullptr && _impl_.geofence_data_ != nullptr) {
...
inline bool UploadGeofenceResponse::_internal_has_geofence_result() const {
  return this != internal_default_instance() && _impl_.geofence_result_ != nullptr;
}
...
inline void UploadGeofenceResponse::clear_geofence_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.geofence_result_ != nullptr) {
