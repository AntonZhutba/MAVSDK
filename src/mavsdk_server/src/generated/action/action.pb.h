...
template<> ::mavsdk::rpc::action::ArmForceRequest* Arena::CreateMaybeMessage<::mavsdk::rpc::action::ArmForceRequest>(Arena*);
template<> ::mavsdk::rpc::action::ArmForceResponse* Arena::CreateMaybeMessage<::mavsdk::rpc::action::ArmForceResponse>(Arena*);
...
constexpr ActionResult_Result ActionResult_Result_Result_MAX = ActionResult_Result_RESULT_INVALID_ARGUMENT;
...
class ArmForceRequest final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:mavsdk.rpc.action.ArmForceRequest) */ {
 public:
  inline ArmForceRequest() : ArmForceRequest(nullptr) {}
  explicit PROTOBUF_CONSTEXPR ArmForceRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ArmForceRequest(const ArmForceRequest& from);
  ...
  ArmForceRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit ArmForceRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class ArmForceResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mavsdk.rpc.action.ArmForceResponse) */ {
 public:
  inline ArmForceResponse() : ArmForceResponse(nullptr) {}
  ~ArmForceResponse() override;
  explicit PROTOBUF_CONSTEXPR ArmForceResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ArmForceResponse(const ArmForceResponse& from);
  ...
  ArmForceResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit ArmForceResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class ActionResult final :
 ...
 public:
  ...
  static constexpr Result RESULT_INVALID_ARGUMENT =
    ActionResult_Result_RESULT_INVALID_ARGUMENT;
...
inline bool ArmResponse::_internal_has_action_result() const {
  return this != internal_default_instance() && _impl_.action_result_ != nullptr;
}
...
// .mavsdk.rpc.action.ActionResult action_result = 1;
inline bool ArmForceResponse::_internal_has_action_result() const {
  return this != internal_default_instance() && _impl_.action_result_ != nullptr;
}
...
inline const ::mavsdk::rpc::action::ActionResult& ArmForceResponse::action_result() const {
...
inline ::mavsdk::rpc::action::ActionResult* ArmForceResponse::mutable_action_result() {
  ::mavsdk::rpc::action::ActionResult* _msg = _internal_mutable_action_result();
  // @@protoc_insertion_point(field_mutable:mavsdk.rpc.action.ArmForceResponse.action_result)
  return _msg;
}
inline void ArmForceResponse::set_allocated_action_result(::mavsdk::rpc::action::ActionResult* action_result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.action_result_;
  }
