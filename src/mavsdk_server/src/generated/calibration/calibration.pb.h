...
inline bool CalibrateGyroResponse::_internal_has_calibration_result() const {
  return this != internal_default_instance() && _impl_.calibration_result_ != nullptr;
}
...
inline void CalibrateGyroResponse::clear_calibration_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.calibration_result_ != nullptr) {
...
void ProgressData::set_status_text(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.status_text_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ProgressData::set_allocated_status_text(std::string* status_text) {
  ...
  _impl_.status_text_.SetAllocated(status_text, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
