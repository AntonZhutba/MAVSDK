...
inline bool PlayTuneRequest::_internal_has_tune_description() const {
  return this != internal_default_instance() && _impl_.tune_description_ != nullptr;
}
...
inline bool PlayTuneResponse::_internal_has_tune_result() const {
  return this != internal_default_instance() && _impl_.tune_result_ != nullptr;
}
...
inline ::mavsdk::rpc::tune::SongElement TuneDescription::_internal_song_elements(int index) const {
  return static_cast< ::mavsdk::rpc::tune::SongElement >(_impl_.song_elements_.Get(index));
}
...
inline void TuneDescription::set_song_elements(int index, ::mavsdk::rpc::tune::SongElement value) {
  _impl_.song_elements_.Set(index, value);
...
inline void TuneDescription::_internal_add_song_elements(::mavsdk::rpc::tune::SongElement value) {
  _impl_.song_elements_.Add(value);
}
