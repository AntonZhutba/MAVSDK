...
template<> ::mavsdk::rpc::mission_raw::DownloadGeofenceRequest* Arena::CreateMaybeMessage<::mavsdk::rpc::mission_raw::DownloadGeofenceRequest>(Arena*);
template<> ::mavsdk::rpc::mission_raw::DownloadGeofenceResponse* Arena::CreateMaybeMessage<::mavsdk::rpc::mission_raw::DownloadGeofenceResponse>(Arena*);
...
template<> ::mavsdk::rpc::mission_raw::DownloadRallypointsRequest* Arena::CreateMaybeMessage<::mavsdk::rpc::mission_raw::DownloadRallypointsRequest>(Arena*);
template<> ::mavsdk::rpc::mission_raw::DownloadRallypointsResponse* Arena::CreateMaybeMessage<::mavsdk::rpc::mission_raw::DownloadRallypointsResponse>(Arena*);
...
class DownloadGeofenceRequest final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:mavsdk.rpc.mission_raw.DownloadGeofenceRequest) */ {
 public:
  inline DownloadGeofenceRequest() : DownloadGeofenceRequest(nullptr) {}
  explicit PROTOBUF_CONSTEXPR DownloadGeofenceRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  DownloadGeofenceRequest(const DownloadGeofenceRequest& from);
  ...
  DownloadGeofenceRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit DownloadGeofenceRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class DownloadGeofenceResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mavsdk.rpc.mission_raw.DownloadGeofenceResponse) */ {
 public:
  inline DownloadGeofenceResponse() : DownloadGeofenceResponse(nullptr) {}
  ~DownloadGeofenceResponse() override;
  explicit PROTOBUF_CONSTEXPR DownloadGeofenceResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  DownloadGeofenceResponse(const DownloadGeofenceResponse& from);
  ...
  DownloadGeofenceResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit DownloadGeofenceResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class DownloadRallypointsRequest final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:mavsdk.rpc.mission_raw.DownloadRallypointsRequest) */ {
 public:
  inline DownloadRallypointsRequest() : DownloadRallypointsRequest(nullptr) {}
  explicit PROTOBUF_CONSTEXPR DownloadRallypointsRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  DownloadRallypointsRequest(const DownloadRallypointsRequest& from);
  ...
  DownloadRallypointsRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit DownloadRallypointsRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class DownloadRallypointsResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mavsdk.rpc.mission_raw.DownloadRallypointsResponse) */ {
 public:
  inline DownloadRallypointsResponse() : DownloadRallypointsResponse(nullptr) {}
  ~DownloadRallypointsResponse() override;
  explicit PROTOBUF_CONSTEXPR DownloadRallypointsResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  DownloadRallypointsResponse(const DownloadRallypointsResponse& from);
  ...
  DownloadRallypointsResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit DownloadRallypointsResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  private:
  const ::mavsdk::rpc::mission_raw::MissionItem& _internal_rallypoint_items(int index) const;
  ::mavsdk::rpc::mission_raw::MissionItem* _internal_add_rallypoint_items();
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::mavsdk::rpc::mission_raw::MissionItem > rallypoint_items_;
    ::mavsdk::rpc::mission_raw::MissionRawResult* mission_raw_result_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
inline bool UploadMissionResponse::_internal_has_mission_raw_result() const {
  return this != internal_default_instance() && _impl_.mission_raw_result_ != nullptr;
}
...
// .mavsdk.rpc.mission_raw.MissionRawResult mission_raw_result = 1;
inline bool DownloadGeofenceResponse::_internal_has_mission_raw_result() const {
  return this != internal_default_instance() && _impl_.mission_raw_result_ != nullptr;
}
...
inline const ::mavsdk::rpc::mission_raw::MissionRawResult& DownloadGeofenceResponse::mission_raw_result() const {
...
inline ::mavsdk::rpc::mission_raw::MissionRawResult* DownloadGeofenceResponse::mutable_mission_raw_result() {
  ::mavsdk::rpc::mission_raw::MissionRawResult* _msg = _internal_mutable_mission_raw_result();
  // @@protoc_insertion_point(field_mutable:mavsdk.rpc.mission_raw.DownloadGeofenceResponse.mission_raw_result)
  return _msg;
}
inline void DownloadGeofenceResponse::set_allocated_mission_raw_result(::mavsdk::rpc::mission_raw::MissionRawResult* mission_raw_result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.mission_raw_result_;
  }
...
inline ::mavsdk::rpc::mission_raw::MissionItem* DownloadGeofenceResponse::mutable_geofence_items(int index) {
  ...
  return _impl_.geofence_items_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::mavsdk::rpc::mission_raw::MissionItem >*
DownloadGeofenceResponse::mutable_geofence_items() {
...
inline const ::mavsdk::rpc::mission_raw::MissionItem& DownloadGeofenceResponse::_internal_geofence_items(int index) const {
  return _impl_.geofence_items_.Get(index);
}
...
inline ::mavsdk::rpc::mission_raw::MissionItem* DownloadGeofenceResponse::_internal_add_geofence_items() {
  return _impl_.geofence_items_.Add();
}
inline ::mavsdk::rpc::mission_raw::MissionItem* DownloadGeofenceResponse::add_geofence_items() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::mavsdk::rpc::mission_raw::MissionItem >&
DownloadGeofenceResponse::geofence_items() const {
...
// .mavsdk.rpc.mission_raw.MissionRawResult mission_raw_result = 1;
inline bool DownloadRallypointsResponse::_internal_has_mission_raw_result() const {
  return this != internal_default_instance() && _impl_.mission_raw_result_ != nullptr;
}
...
inline const ::mavsdk::rpc::mission_raw::MissionRawResult& DownloadRallypointsResponse::mission_raw_result() const {
...
inline ::mavsdk::rpc::mission_raw::MissionRawResult* DownloadRallypointsResponse::mutable_mission_raw_result() {
  ::mavsdk::rpc::mission_raw::MissionRawResult* _msg = _internal_mutable_mission_raw_result();
  // @@protoc_insertion_point(field_mutable:mavsdk.rpc.mission_raw.DownloadRallypointsResponse.mission_raw_result)
  return _msg;
}
inline void DownloadRallypointsResponse::set_allocated_mission_raw_result(::mavsdk::rpc::mission_raw::MissionRawResult* mission_raw_result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.mission_raw_result_;
  }
...
inline int DownloadRallypointsResponse::_internal_rallypoint_items_size() const {
  return _impl_.rallypoint_items_.size();
}
...
inline ::mavsdk::rpc::mission_raw::MissionItem* DownloadRallypointsResponse::mutable_rallypoint_items(int index) {
  ...
  return _impl_.rallypoint_items_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::mavsdk::rpc::mission_raw::MissionItem >*
DownloadRallypointsResponse::mutable_rallypoint_items() {
...
inline const ::mavsdk::rpc::mission_raw::MissionItem& DownloadRallypointsResponse::_internal_rallypoint_items(int index) const {
  return _impl_.rallypoint_items_.Get(index);
}
inline const ::mavsdk::rpc::mission_raw::MissionItem& DownloadRallypointsResponse::rallypoint_items(int index) const {
  ...
  return _internal_rallypoint_items(index);
}
inline ::mavsdk::rpc::mission_raw::MissionItem* DownloadRallypointsResponse::_internal_add_rallypoint_items() {
  return _impl_.rallypoint_items_.Add();
}
inline ::mavsdk::rpc::mission_raw::MissionItem* DownloadRallypointsResponse::add_rallypoint_items() {
  ::mavsdk::rpc::mission_raw::MissionItem* _add = _internal_add_rallypoint_items();
  // @@protoc_insertion_point(field_add:mavsdk.rpc.mission_raw.DownloadRallypointsResponse.rallypoint_items)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::mavsdk::rpc::mission_raw::MissionItem >&
DownloadRallypointsResponse::rallypoint_items() const {
...
inline bool MissionProgressResponse::_internal_has_mission_progress() const {
  return this != internal_default_instance() && _impl_.mission_progress_ != nullptr;
}
...
void ImportQgroundcontrolMissionRequest::set_qgc_plan_path(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.qgc_plan_path_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ImportQgroundcontrolMissionRequest::set_allocated_qgc_plan_path(std::string* qgc_plan_path) {
  ...
  _impl_.qgc_plan_path_.SetAllocated(qgc_plan_path, GetArenaForAllocation());
...
inline bool ImportQgroundcontrolMissionResponse::_internal_has_mission_import_data() const {
  return this != internal_default_instance() && _impl_.mission_import_data_ != nullptr;
}
...
void ImportQgroundcontrolMissionFromStringRequest::set_qgc_plan(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.qgc_plan_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ImportQgroundcontrolMissionFromStringRequest::set_allocated_qgc_plan(std::string* qgc_plan) {
  ...
  _impl_.qgc_plan_.SetAllocated(qgc_plan, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
