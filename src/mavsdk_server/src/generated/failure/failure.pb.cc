...
InjectRequest::InjectRequest(const InjectRequest& from)
  ...
  InjectRequest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.failure_unit_){}
    , decltype(_impl_.failure_type_){}
    , decltype(_impl_.instance_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.failure_unit_, &from._impl_.failure_unit_,
...
// @@protoc_insertion_point(message_clear_start:mavsdk.rpc.failure.InjectResponse)
  ...
  if (GetArenaForAllocation() == nullptr && _impl_.failure_result_ != nullptr) {
