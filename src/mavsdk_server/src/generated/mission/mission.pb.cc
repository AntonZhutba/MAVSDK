...
// @@protoc_insertion_point(message_clear_start:mavsdk.rpc.mission.UploadMissionRequest)
  ...
  if (GetArenaForAllocation() == nullptr && _impl_.mission_plan_ != nullptr) {
...
// @@protoc_insertion_point(message_clear_start:mavsdk.rpc.mission.UploadMissionResponse)
  ...
  if (GetArenaForAllocation() == nullptr && _impl_.mission_result_ != nullptr) {
...
SetReturnToLaunchAfterMissionRequest::SetReturnToLaunchAfterMissionRequest(const SetReturnToLaunchAfterMissionRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  SetReturnToLaunchAfterMissionRequest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.enable_){}
    , /*decltype(_impl_._cached_size_)*/{}};
...
MissionItem::MissionItem(const MissionItem& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.is_fly_through_){}
    , decltype(_impl_.gimbal_pitch_deg_){}
    , decltype(_impl_.gimbal_yaw_deg_){}
    , decltype(_impl_.camera_action_){}
    , decltype(_impl_.camera_photo_interval_s_){}
    , decltype(_impl_.loiter_time_s_){}
    , decltype(_impl_.acceptance_radius_m_){}
    , decltype(_impl_.yaw_deg_){}
    , decltype(_impl_.camera_photo_distance_m_){}
    , decltype(_impl_.vehicle_action_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.latitude_deg_, &from._impl_.latitude_deg_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.vehicle_action_) -
