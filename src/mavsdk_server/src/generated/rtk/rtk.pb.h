...
void RtcmData::set_data_base64(ArgT0&& arg0, ArgT... args) {
...
inline std::string* RtcmData::mutable_data_base64() {
...
inline void RtcmData::set_allocated_data_base64(std::string* data_base64) {
...
inline bool SendRtcmDataRequest::_internal_has_rtcm_data() const {
  return this != internal_default_instance() && _impl_.rtcm_data_ != nullptr;
}
...
inline void SendRtcmDataRequest::clear_rtcm_data() {
  if (GetArenaForAllocation() == nullptr && _impl_.rtcm_data_ != nullptr) {
...
inline bool SendRtcmDataResponse::_internal_has_rtk_result() const {
  return this != internal_default_instance() && _impl_.rtk_result_ != nullptr;
}
...
inline void SendRtcmDataResponse::clear_rtk_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.rtk_result_ != nullptr) {
