...
#include "custom/custom_service_impl.h"
#endif
...
#ifdef CUSTOM_ENABLED
    _custom_lazy_plugin(mavsdk),
    _custom_service(_custom_lazy_plugin),
#endif
...
private:
    ...
    LazyPlugin<Custom> _custom_lazy_plugin;

    CustomServiceImpl<> _custom_service;
#endif
